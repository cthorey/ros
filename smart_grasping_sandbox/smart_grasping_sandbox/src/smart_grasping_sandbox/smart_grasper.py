...
class SmartGrasper(object):
    ...
    def __init__(self):
        ...
        self.__joint_state_sub = rospy.Subscriber(
            "/joint_states", JointState, self.__joint_state_cb, queue_size=1)
        ...
        self.__get_planning_scene = rospy.ServiceProxy('/get_planning_scene',
                                                       GetPlanningScene)
        self.__pub_planning_scene = rospy.Publisher(
            '/planning_scene', PlanningScene, queue_size=10, latch=True)
    ...
    def reset_world(self):
        ...
        self.__set_model.call(
            model_name="smart_grasping_sandbox",
    ...
    def move_tip(self, x=0., y=0., z=0., roll=0., pitch=0., yaw=0.):
        ...
        transform = PyKDL.Frame(
            PyKDL.Rotation.RPY(pitch, roll, yaw), PyKDL.Vector(-x, -y, -z))
